...
module.exports = configure(function (ctx) {
  return {
    ...
    boot: ["basics", "i18n", "axios", "addressbar-color", "fontawesome-pro", "notify-defaults"],
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ["BottomSheet", "LocalStorage", "Meta", "Notify"],
    },
    ...
    pwa: {
      ...
      manifest: {
        ...
        short_name: `Dobby`,
        description: `Keep track of your loans on DeFiChain to not get liquidated.`,
        display: "standalone",

...
@component('mail::table')
    ...
    | ------------- | ------------- |:-------------:| :----------------: | :--------: |
    | {{ $vaultName ?? 'n/a' }} | {{ str_truncate_middle($vault->vaultId, 15) }} | {{ $vault->collateralRatio }} %|{{number_format_for_language($vault->collateralValue) }} USD | {{ number_format_for_language($vault->loanValue) }} USD |
@endcomponent
